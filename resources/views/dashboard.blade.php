...
<head>
    ...
    <style>
        ...
        .bg {
            width: 100%;
            height: 500px;
            background: url("https://ik.imagekit.io/norice/undraw_No_data_re_kwbl_2_1_ZJSDps0I7.svg");
...
<nav class="navbar navbar-expand-md navbar-light bg-light">
    ...
    <div class="mx-auto order-0">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="#">On-going <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <label
                                                        for="code"
                                                        style="font-family: Inter;font-style: normal;font-weight: bold;font-size: 16px;line-height: 22px; color: #4F4F4F;"
                                                    >Exam
                                                        Code:</label
                                                    >
                                                </div>
                                                <form method="POST" action="/student/join">
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            style="width: 100%;background: #092C4C;
