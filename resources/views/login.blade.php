...
<head>
    ...
    <title>Login - Exam Checker</title>
						...
						<auth-form
							...
							<form class="form-horizontal" role="form" method="POST" action="http://localhost:8000/login" novalidate>
								...
								<div align="center" class="auth-body" style="padding-bottom: 12px;">
									...
									<p class="auth-subtitle">Don’t have an account? <a href="/signup"><span style="color:#092C4C;"><b>Sign Up here</b></span></a></p>
								</div>
								<div class="auth-body">
										...
										<div class="input-group input-group--custom">
											...
											<input type="text" v-model="form.email" v-validate="'required|email'" class="form-control" :class="{'form-control-danger': errors.has('email'), 'form-control-success': fields.email && fields.email.valid}" id="email" name="email" placeholder="name@domain.com">
										</div>
									...
									<div class="form-group" :class="{'has-danger': errors.has('password'), 'has-success': fields.password && fields.password.valid }">
										...
										<div class="input-group input-group--custom">
											...
											<input type="password" v-model="form.password"  class="form-control" :class="{'form-control-danger': errors.has('password'), 'form-control-success': fields.password && fields.password.valid}" id="password" name="password" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
										</div>
										<div class="form-control-feedback form-text"></div>
									</div>
